...
Este capítulo explica **cómo organizaremos el proyecto en GitHub**:
...
> En este handbook sí se usa CI para generar la web, y puedes tomarlo como ejemplo. Puedes echar un vistazo a su [repositorio de github](https://github.com/juanluck/yet-another-tfg-tfm-handbook).

---

## Organización de GitHub por proyecto
...
Ejemplo de organización de TFG ya creada:

- [TempusUGR](https://github.com/TempusUGR/)
...
## Ramificación (branches) y flujo de trabajo básico
...
## Integración continua (CI): recomendada, no obligatoria

### ¿Cuándo tiene sentido usar CI?
...
### Ejemplo de workflow mínimo (Python)
...
## Checklist inicial para el alumno
...
6. [ ] Si decides usarla, crea un workflow sencillo para lanzar tests o validaciones básicas en cada push.
