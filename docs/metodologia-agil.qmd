---
title: "Metodología ágil para TFG/TFM"
format:
  html:
    toc: true
---
...
# 2. Enfoque general: ágil adaptado a TFG/TFM
...
# 3. Roles en el proyecto

En este contexto, los roles se mapean así:

## 3.1. Alumno/a (equipo de desarrollo)
...
## 3.3. Otros actores (stakeholders)
...
# 5. Sprints: cómo iterar el trabajo
...
# 6. Fases típicas de un TFG/TFM (vista ágil)

Aunque trabajemos con sprints, normalmente podemos distinguir varias **fases**:

## 6.1. Fase 1: Arranque y planificación
...
## 6.3. Fase 3: Implementación iterativa
...
## 6.4. Fase 4: Evaluación y refinamiento
...
## 6.5. Fase 5: Cierre y documentación
...
# 7. Calidad, pruebas y CI (opcional para el alumno)

## 7.1. Calidad mínima esperada
...
## 7.2. Integración continua (CI) como opción
...
# 8. Expectativas de comunicación
...
# 9. Cómo se concreta esto en tu TFG/TFM
